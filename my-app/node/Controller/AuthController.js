...
var routes = function (){
    ...
    router.route('/signup')
        .post(function (req, res){
            ...
            connection.query('SELECT username FROM `userlist` WHERE userlist.username LIKE "'+req.headers.user+'"', function (error, results, fields) {
                ...
                try {
                    if (results[0].username == req.headers.user){
                    ...
                    try {
                        ...
                        var hashPass = bcrypt.hashSync(req.headers.password, 10);
